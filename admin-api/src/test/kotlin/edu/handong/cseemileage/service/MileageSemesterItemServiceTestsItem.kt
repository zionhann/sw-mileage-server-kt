...
import edu.handong.cseemileage.controller.MileageCategoryIntegrationTests
import edu.handong.cseemileage.controller.MileageItemIntegrationTests
import edu.handong.cseemileage.controller.MileageSemesterIntegrationTestsItem.Companion.ITEM_MAX_POINTS
import edu.handong.cseemileage.controller.MileageSemesterIntegrationTestsItem.Companion.POINT_VALUE
import edu.handong.cseemileage.controller.MileageSemesterIntegrationTestsItem.Companion.SEMESTER_NAME
import edu.handong.cseemileage.controller.MileageSemesterIntegrationTestsItem.Companion.UPDATE_ITEM_MAX_POINTS
import edu.handong.cseemileage.controller.MileageSemesterIntegrationTestsItem.Companion.UPDATE_POINT_VALUE
import edu.handong.cseemileage.controller.MileageSemesterIntegrationTestsItem.Companion.UPDATE_SEMESTER_NAME
...
class MileageSemesterItemServiceTestsItem @Autowired constructor(
    ...
    fun prepareData(): Map<String, Any> {
        val category1 = Category(MileageCategoryIntegrationTests.NAME)
        val category2 = Category("category2")
        categoryRepository.save(category1)
        categoryRepository.save(category2)
        val item1 = MileageItemServiceTests.createDefaultItem(category1, MileageItemIntegrationTests.NAME)
        itemRepository.save(item1)
        val item2 = MileageItemServiceTests.createDefaultItem(category2, MileageItemIntegrationTests.NAME)
